 ...
 */
public class ConstantConfigCenterNotFoundException extends ConstantConfigCenterException {
    ...
    public ConstantConfigCenterNotFoundException(String locateField, Object locateValue) {
